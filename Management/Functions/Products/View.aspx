<%@ Page Title="Modifica Prodotto" Language="C#" MasterPageFile="~/Management/MasterPage.master" AutoEventWireup="true" CodeFile="View.aspx.cs" Inherits="Management_Functions_Products_View" %>
    ...
    <div class="main-content">
        <div class="content-wrapper">
            ...
            <section id="basic-form-layouts">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="content-header">Modifica Prodotto Sito Web</div>
                    </div>
                                    ...
                                    <div class="form">
                                        <div class="form-body">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="projectinput1">Secondo Nome</label>                                                        
                                                        <asp:TextBox runat="server" class="form-control" ID="txtSecondName" />
                                                    </div>
                                                    <div class="form-group">
                                        ...
                                        <div class="form-actions right">
                                            ...
                                            <asp:LinkButton Text="Annulla" runat="server" class="btn btn-warning"
                                                UseSubmitBehavior="false" ID="bttAnnulla" PostBackUrl="~/Management/Functions/Products/" />
