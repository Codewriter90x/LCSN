<%@ Page Title="Lista News" Language="C#" MasterPageFile="~/Management/MasterPage.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="Gestione_Funzioni_Blog_Default2" %>
        ...
        <div class="content-wrapper">
            <div class="row">
                <div class="col-sm-12 col-md-5">
                    <div class="content-header">Gestione area News</div>
                    <p class="content-sub-header">Aggiungi, modifica e visualizza dettagli relative alle tue news.</p>
                </div>
            </div>
            <section id="extended">
                <div class="row">
                                    ...
                                    <table class="table table-responsive-md-md text-center">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="text-align:left;"><asp:literal text="Categoria" runat="server" /></th>
                                        ...
                                        <tbody id="tableContentNews">
                                            ...
                                            <script type="text/javascript">
                                                ...
                                                function GetPosts() {
                                                    ...
                                                    $.ajax({
                                                        type: "POST",
                                                        url: "//admin.Laboratorioforgia.it/App_Services/DynamicNewsLoader.asmx/Getnews",
                                                        data: "{'ID':'', 'Title':'" + txtNome + "', 'PageNo':'" + txtCreazione + "', 'PositionNo':'" + SelStatus + "', 'CategoryID': '" + txtCategoria +"'}",
                                                        ...
                                                        success: function (responseFromServer) {
                                                            ...
                                                            for (i = 0; i < data.length; i++) {
                                                                ...
                                                                composer += "<td style='text-align: left;'>" + data[i]['CustomUrl'];
                                                                composer += "<a href='//admin.laboratorioforgia.it/Management/Functions/News/View/" + data[i]['ID'] + '/' + data[i]['UrlTitle'] + "'>" + data[i]['Title'] + "</td>";
                                                                composer += "<td style='text-align: left;'></td>";
                                                                composer += "<td>" + data[i]['GoogleTagsStatus'] + "</td>";
                                                                composer += "<td>" + data[i]['SocialTagsStatus'] + "</td>";
                                                                composer += "<td>Pag: " + data[i]['PageNo'] + ", pos:" + data[i]['PositionNo'] + "</td>";
                                                                composer += "<td style='text-align: left;'>" + data[i]['DataIns'] + "</td>";
                                                                composer += "<td style='text-align: center'></td>";
                                                                composer += "</tr>";
                                                            }
                                                            $(".dataItem").remove();
                                                            document.getElementById("tableContentNews").innerHTML += composer;
